...
parser.add_argument('--model_name', type=str, default='LFSSR_HI', help="model name")
...
parser.add_argument("--path_pre_pth", type=str, default='./pretrain/LFSSR_HI_5x5_8x_model.pth',
