...
parser.add_argument('--model_name', type=str, default='LFSSR_ESAPE', help="model name")
...
parser.add_argument("--path_pre_pth", type=str, default='./pretrain/LFSSR_ESAPE_5x5_8x_model.pth',
...
parser.add_argument('--path_for_train', type=str, default='./dataset/data_for_training/')
parser.add_argument('--path_for_test', type=str, default='./dataset/data_for_test/')
parser.add_argument('--path_for_val', type=str, default='./dataset/data_for_val/')
...
parser.add_argument('--resume', default=True, type=str, help='Path for checkpoint to load and resume')
...
parser.add_argument('--minibatch_for_test', default=1, type=int, help='minibatch in test/validation')
