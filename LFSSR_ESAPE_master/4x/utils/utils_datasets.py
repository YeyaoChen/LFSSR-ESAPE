...
class TrainSetDataLoader(Dataset):
    ...
    def __getitem__(self, index):
        ...
        with h5py.File(file_name[0], 'r') as hf1, h5py.File(ref_file_name[0], 'r') as hf2:
            ...
            data, label, ref, label_down2 = augmentation_4(Lr_SAI_y, Hr_SAI_y, ref_y, hr_down2)
            ...
            return Lr_SAI_y, Hr_SAI_y, ref_SAI_y,  hr_down2
...
class ValSetDataLoader(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return Lr_SAI_y, Hr_SAI_y, ref_y, Sr_SAI_cbcr, LF_name
